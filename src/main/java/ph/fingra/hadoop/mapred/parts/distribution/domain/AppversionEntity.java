...
public class AppversionEntity extends BaseWritable<AppversionEntity> {
     ...
     * @throws IOException
     */
    public static AppversionEntity read(DataInput in) throws IOException {
        
        AppversionEntity l = new AppversionEntity();
        l.readFields(in);
        return l;
    }
}
