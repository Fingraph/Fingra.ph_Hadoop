...
public class UserSessionEntity extends BaseWritable<UserSessionEntity> {
     ...
     * @throws IOException
     */
    public static UserSessionEntity read(DataInput in) throws IOException {
        
        UserSessionEntity l = new UserSessionEntity();
        l.readFields(in);
        return l;
    }
}
