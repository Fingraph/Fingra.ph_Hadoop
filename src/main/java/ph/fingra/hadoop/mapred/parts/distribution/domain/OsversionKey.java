...
public class OsversionKey extends BaseWritableComparable<OsversionKey> {
    ...
    public void set(String appkey, String osversion, String token, String session) {
    ...
    @Override
    public int compareTo(OsversionKey o) {
