...
public class ComponentDeviceKey extends BaseWritableComparable<ComponentDeviceKey> {
    ...
    public void set(String appkey, String componentkey, String device, String token, String session) {
    ...
    @Override
    public int compareTo(ComponentDeviceKey o) {
