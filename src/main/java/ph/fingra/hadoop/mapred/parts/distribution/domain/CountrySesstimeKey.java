...
public class CountrySesstimeKey extends BaseWritableComparable<CountrySesstimeKey> {
    ...
    public void set(String appkey, String country, String session, String utctime) {
    ...
    @Override
    public int compareTo(CountrySesstimeKey o) {
