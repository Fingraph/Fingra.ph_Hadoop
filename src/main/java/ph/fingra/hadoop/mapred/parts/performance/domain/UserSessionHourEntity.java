...
public class UserSessionHourEntity extends BaseWritable<UserSessionHourEntity> {
    ...
    public void set(String token, String session, String hour, String cmd) {
     ...
     * @throws IOException
     */
    public static UserSessionHourEntity read(DataInput in) throws IOException {
        
        UserSessionHourEntity l = new UserSessionHourEntity();
        l.readFields(in);
        return l;
    }
}
