...
public class AppversionKey extends BaseWritableComparable<AppversionKey> {
    ...
    public void set(String appkey, String appversion, String token, String session) {
    ...
    @Override
    public int compareTo(AppversionKey o) {
