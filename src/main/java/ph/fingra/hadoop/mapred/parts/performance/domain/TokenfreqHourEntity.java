...
public class TokenfreqHourEntity extends BaseWritable<TokenfreqHourEntity> {
     ...
     * @throws IOException
     */
    public static TokenfreqHourEntity read(DataInput in) throws IOException {
        
        TokenfreqHourEntity l = new TokenfreqHourEntity();
        l.readFields(in);
        return l;
    }
}
