...
public class CountrySesstimeEntity extends BaseWritable<CountrySesstimeEntity> {
     ...
     * @throws IOException
     */
    public static CountrySesstimeEntity read(DataInput in) throws IOException {
        
        CountrySesstimeEntity l = new CountrySesstimeEntity();
        l.readFields(in);
        return l;
    }
}
