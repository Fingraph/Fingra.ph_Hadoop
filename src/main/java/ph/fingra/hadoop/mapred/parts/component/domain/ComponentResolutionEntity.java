...
public class ComponentResolutionEntity extends BaseWritable<ComponentResolutionEntity> {
     ...
     * @throws IOException
     */
    public static ComponentResolutionEntity read(DataInput in) throws IOException {
        
        ComponentResolutionEntity l = new ComponentResolutionEntity();
        l.readFields(in);
        return l;
    }
}
