...
public class OsversionEntity extends BaseWritable<OsversionEntity> {
     ...
     * @throws IOException
     */
    public static OsversionEntity read(DataInput in) throws IOException {
        
        OsversionEntity l = new OsversionEntity();
        l.readFields(in);
        return l;
    }
}
