...
public class ComponentTokenfreqEntity
    extends BaseWritable<ComponentTokenfreqEntity> {
     ...
     * @throws IOException
     */
    public static ComponentTokenfreqEntity read(DataInput in) throws IOException {
        
        ComponentTokenfreqEntity l = new ComponentTokenfreqEntity();
        l.readFields(in);
        return l;
    }
}
