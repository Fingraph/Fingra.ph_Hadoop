...
public class ComponentCountryKey extends BaseWritableComparable<ComponentCountryKey> {
    ...
    public void set(String appkey, String componentkey, String country, String token, String session) {
    ...
    @Override
    public int compareTo(ComponentCountryKey o) {
