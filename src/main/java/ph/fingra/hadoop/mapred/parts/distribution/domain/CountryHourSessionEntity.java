...
public class CountryHourSessionEntity extends BaseWritable<CountryHourSessionEntity> {
     ...
     * @throws IOException
     */
    public static CountryHourSessionEntity read(DataInput in) throws IOException {
        
        CountryHourSessionEntity l = new CountryHourSessionEntity();
        l.readFields(in);
        return l;
    }
}
