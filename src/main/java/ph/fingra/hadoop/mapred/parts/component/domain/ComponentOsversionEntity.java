...
public class ComponentOsversionEntity extends BaseWritable<ComponentOsversionEntity> {
     ...
     * @throws IOException
     */
    public static ComponentOsversionEntity read(DataInput in) throws IOException {
        
        ComponentOsversionEntity l = new ComponentOsversionEntity();
        l.readFields(in);
        return l;
    }
}
