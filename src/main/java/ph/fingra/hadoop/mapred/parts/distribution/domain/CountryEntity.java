...
public class CountryEntity extends BaseWritable<CountryEntity> {
     ...
     * @throws IOException
     */
    public static CountryEntity read(DataInput in) throws IOException {
        
        CountryEntity l = new CountryEntity();
        l.readFields(in);
        return l;
    }
}
