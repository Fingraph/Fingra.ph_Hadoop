...
public class ComponentLanguageEntity extends BaseWritable<ComponentLanguageEntity> {
     ...
     * @throws IOException
     */
    public static ComponentLanguageEntity read(DataInput in) throws IOException {
        
        ComponentLanguageEntity l = new ComponentLanguageEntity();
        l.readFields(in);
        return l;
    }
}
