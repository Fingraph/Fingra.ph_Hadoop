...
public class ResolutionKey extends BaseWritableComparable<ResolutionKey> {
    ...
    public void set(String appkey, String resolution, String token, String session) {
    ...
    @Override
    public int compareTo(ResolutionKey o) {
