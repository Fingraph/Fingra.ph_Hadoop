...
public class ComponentLanguageKey extends BaseWritableComparable<ComponentLanguageKey> {
    ...
    public void set(String appkey, String componentkey, String language, String token, String session) {
