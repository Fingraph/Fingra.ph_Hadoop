...
public class ComponentCountryEntity extends BaseWritable<ComponentCountryEntity> {
     ...
     * @throws IOException
     */
    public static ComponentCountryEntity read(DataInput in) throws IOException {
        
        ComponentCountryEntity l = new ComponentCountryEntity();
        l.readFields(in);
        return l;
    }
}
