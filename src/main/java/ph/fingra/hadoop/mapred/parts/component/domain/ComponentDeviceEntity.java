...
public class ComponentDeviceEntity extends BaseWritable<ComponentDeviceEntity> {
     ...
     * @throws IOException
     */
    public static ComponentDeviceEntity read(DataInput in) throws IOException {
        
        ComponentDeviceEntity l = new ComponentDeviceEntity();
        l.readFields(in);
        return l;
    }
}
