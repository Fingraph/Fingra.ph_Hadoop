...
public class ComponentOsversionKey extends BaseWritableComparable<ComponentOsversionKey> {
    ...
    public void set(String appkey, String componentkey, String osversion, String token, String session) {
