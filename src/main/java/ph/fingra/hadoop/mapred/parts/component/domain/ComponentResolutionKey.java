...
public class ComponentResolutionKey extends BaseWritableComparable<ComponentResolutionKey> {
    ...
    public void set(String appkey, String componentkey, String resolution, String token, String session) {
