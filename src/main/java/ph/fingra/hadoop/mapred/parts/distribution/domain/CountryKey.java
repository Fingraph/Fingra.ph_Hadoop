...
public class CountryKey extends BaseWritableComparable<CountryKey> {
    ...
    public void set(String appkey, String country, String token, String session) {
    ...
    @Override
    public int compareTo(CountryKey o) {
