...
public class ComponentAppversionKey extends BaseWritableComparable<ComponentAppversionKey> {
    ...
    public void set(String appkey, String componentkey, String appversion, String token, String session) {
