...
public class ComponentNewuserDb extends BaseWritable<ComponentNewuserDb> {
     ...
     * @throws IOException
     */
    public static ComponentNewuserDb read(DataInput in) throws IOException {
        
        ComponentNewuserDb l = new ComponentNewuserDb();
        l.readFields(in);
        return l;
    }
    
    public void copy(ComponentNewuserDb source) {
        
        this.appkey = source.appkey;
        this.componentkey = source.componentkey;
