...
public class ComponentNewuserDbParser {
    ...
    private static Pattern COMPONENTNEWUSERDB_PATTERN;
    static {
        COMPONENTNEWUSERDB_PATTERN = Pattern.compile(COMPONENTNEWUSERDB_PATTERN_REGEX);
    }
    ...
    public ComponentNewuserDbParser() {
    ...
    private void parse(String record) {
        ...
        if (COMPONENTNEWUSERDB_PATTERN.matcher(record).matches() == true) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ComponentNewuserDbParser parser = new ComponentNewuserDbParser();
