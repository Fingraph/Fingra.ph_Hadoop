...
public class CompoAppversionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 3385487338458122220L;
    ...
    public void copy(CompoAppversionAll src) {
