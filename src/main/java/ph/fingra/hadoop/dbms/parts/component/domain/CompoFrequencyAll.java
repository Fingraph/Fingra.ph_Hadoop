...
public class CompoFrequencyAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -1236280420186944946L;
    ...
    public void copy(CompoFrequencyAll src) {
