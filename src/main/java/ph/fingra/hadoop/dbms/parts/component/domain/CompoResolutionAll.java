...
public class CompoResolutionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 8391114035811302650L;
    ...
    public void copy(CompoResolutionAll src) {
