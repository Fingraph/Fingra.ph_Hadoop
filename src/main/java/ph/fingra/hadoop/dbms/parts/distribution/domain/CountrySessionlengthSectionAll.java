...
public class CountrySessionlengthSectionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -9189264269261488588L;
    ...
    public void copy(CountrySessionlengthSectionAll src) {
