...
public class SessionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -1388991057062176686L;
    ...
    public void copy(SessionAll src) {
