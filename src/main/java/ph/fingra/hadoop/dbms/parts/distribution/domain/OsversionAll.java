...
public class OsversionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 989072259252438080L;
    ...
    public void copy(OsversionAll src) {
