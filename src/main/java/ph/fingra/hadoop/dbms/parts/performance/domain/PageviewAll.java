...
public class PageviewAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -4841845756194339446L;
    ...
    public void copy(PageviewAll src) {
