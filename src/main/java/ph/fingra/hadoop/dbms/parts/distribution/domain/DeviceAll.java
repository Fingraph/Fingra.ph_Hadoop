...
public class DeviceAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -766292734400452859L;
    ...
    public void copy(DeviceAll src) {
