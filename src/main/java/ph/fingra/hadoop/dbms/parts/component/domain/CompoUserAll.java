...
public class CompoUserAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 5904285316764751524L;
    ...
    public void copy(CompoUserAll src) {
