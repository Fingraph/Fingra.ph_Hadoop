...
public class CompoLanguageAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 360901596172287093L;
    ...
    public void copy(CompoLanguageAll src) {
