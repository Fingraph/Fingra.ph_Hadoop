...
public class CountrySessionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -2704153157998054290L;
    ...
    public void copy(CountrySessionAll src) {
