...
public class ResolutionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -2701386049904060236L;
    ...
    public void copy(ResolutionAll src) {
