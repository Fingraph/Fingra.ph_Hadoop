...
public class CompoDeviceAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 5314094716148103066L;
    ...
    public void copy(CompoDeviceAll src) {
