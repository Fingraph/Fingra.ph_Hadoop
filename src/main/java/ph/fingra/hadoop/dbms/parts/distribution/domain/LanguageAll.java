...
public class LanguageAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 7010328168787493611L;
    ...
    public void copy(LanguageAll src) {
