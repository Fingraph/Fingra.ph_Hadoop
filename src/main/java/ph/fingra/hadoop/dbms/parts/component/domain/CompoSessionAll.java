...
public class CompoSessionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 6407547313023173840L;
    ...
    public void copy(CompoSessionAll src) {
