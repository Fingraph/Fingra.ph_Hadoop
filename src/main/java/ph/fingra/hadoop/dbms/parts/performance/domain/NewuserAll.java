...
public class NewuserAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -1400847614276189344L;
    ...
    public void copy(NewuserAll src) {
