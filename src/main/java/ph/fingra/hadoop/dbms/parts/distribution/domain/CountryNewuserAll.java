...
public class CountryNewuserAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 576548368230579496L;
    ...
    public void copy(CountryNewuserAll src) {
