...
public class CompoCountryAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -511192816274864689L;
    ...
    public void copy(CompoCountryAll src) {
