...
public class CompoOsversionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -1406831252243297669L;
    ...
    public void copy(CompoOsversionAll src) {
