...
public class SessionlengthAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 4454463749958811068L;
    ...
    public void copy(SessionlengthAll src) {
