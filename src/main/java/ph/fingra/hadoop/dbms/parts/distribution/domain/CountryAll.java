...
public class CountryAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -2241921540434924068L;
    ...
    public void copy(CountryAll src) {
