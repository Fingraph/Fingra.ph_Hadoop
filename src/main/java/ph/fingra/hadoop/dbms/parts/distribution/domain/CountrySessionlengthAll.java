...
public class CountrySessionlengthAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -3774958014517107495L;
    ...
    public void copy(CountrySessionlengthAll src) {
        ...
        this.sessionlength = src.sessionlength;
