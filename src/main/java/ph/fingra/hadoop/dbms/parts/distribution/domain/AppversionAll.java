...
public class AppversionAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = -6865842123517565681L;
    ...
    public void copy(AppversionAll src) {
