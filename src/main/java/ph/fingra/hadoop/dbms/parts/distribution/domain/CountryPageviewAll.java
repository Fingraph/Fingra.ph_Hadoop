...
public class CountryPageviewAll extends BaseObject implements Serializable {
    
    private static final long serialVersionUID = 1633100472787766017L;
    ...
    public void copy(CountryPageviewAll src) {
